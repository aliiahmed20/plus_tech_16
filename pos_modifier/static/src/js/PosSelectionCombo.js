odoo.define('pos_modifier.PosSelectionCombo', function (require) {
    "use strict";
    ...
    Models.load_fields("product.product",['is_selection_combo', 'product_topping_ids']);

    Models.load_models({
        model: 'product.selection.topping',
        fields: ['id', 'product_categ_id', 'multi_selection', 'product_ids', 'include_price', 'default_quantity',
         'no_of_min_items', 'no_of_items', 'description'],
                ...
                if(product.is_selection_combo) {
                    ...
                    _.each(product.product_topping_ids, function(product_topping_id){
                        ...
                        data.push({
                            ...
                            'include_price': selected_product.include_price,
    ...
    Models.Orderline = Models.Orderline.extend({
        ...
        can_be_merged_with: function(orderline) {
            return !(this.product.is_selection_combo || this.own_data) &&
                   _super_order_line.can_be_merged_with.apply(this,arguments);
        },
            ...
            if(self.product.is_selection_combo && self.own_data) {
                _.each(self.own_data, function(item) {
                    ...
                    own_line.push([0, 0, {
                        ...
                        'include_price': item.include_price,
                        'price_subtotal': item_price * self.get_quantity() * item.qty,
