    ...
    const PosQRCodeOrderReceipt = OrderReceipt =>
        class extends OrderReceipt {
            get receiptEnv() {
                ...
                receipt_render_env.receipt.inv_data = moment(order.creation_date).format('YYYY-MM-DD')
                receipt_render_env.receipt.inv_time = moment(order.creation_date).format('hh:mm')
